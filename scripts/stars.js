	...
	function Constellation (canvas, options) {
        var $canvas = $('#mol1'),
			...
			defaults = {
				...
				width: $('.mol-wrp1').width(),
				height: $('.mol-wrp1').height(),
				velocity: 0.1,
				length: 100,
				distance: 120,
				radius: 150,
	...
	function Constellation (canvas, options) {
        var $canvas = $('#mol2'),
			...
			defaults = {
				...
				width: $('.mol-wrp2').width(),
				height: $('.mol-wrp2').height(),
				velocity: 0.1,
				length: 100,
				distance: 120,
				radius: 150,
